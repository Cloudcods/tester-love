    ...
    <div class="card">
        ...
        <div class="resu">
            <div class="test_result1">
                ...
                <ul class="list">
                    <li>Both enjoy expressing affection through words of 
                                        affirmation</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                    <li>Both enjoy expressing affection through words of affirmation</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                ...
                <ul class="list">
                    <li>They may have different expectations regarding acts of service.</li>
                    <li>Quality time preferences may vary.</li>
                    <li>They may have different expectations regarding acts of service</li>
                    <li>Quality time preferences may vary.</li>
                </ul>
                <div class="b head">
            ...
            <div class="test_result2">
                ...
                <ul class="list">
                    <li>Both enjoy expressing affection through words of affirmation</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                    <li>Both appreciate acts of service and helpful gestures.</li>
                    <li>They can support each other through actions and service.</li>
                ...
                <ul class="list">
                    <li>They may have different expectations regarding acts of service.</li>
                    <li>Quality time preferences may vary.</li>
                    <li>Words of affirmation may not align with their preferences.</li>
                    <li>Physical touch preferences may differ.</li>
                </ul>
                <div class="b head">
                Find common ground and compromise to bridge the gap between your love languages. 
                </div>
            ...
            <div class="test_result3">
                ...
                <ul class="list">
                    <li>Both enjoy expressing affection through words of affirmation.</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                    <li>Both enjoy giving and receiving thoughtful gifts.</li>
                    <li>They can exchange meaningful tokens of affection.</li>
                ...
                <ul class="list">
                    <li>They may have different expectations regarding acts of service.</li>
                    <li>Quality time preferences may vary.</li>
                    <li>Quality time preferences may not match.</li>
                    <li>Acts of service preferences may differ.</li>
                </ul>
                <div class="b head">
                Find common ground and compromise to bridge the gap between your love languages. 
                </div>
            ...
            <div class="test_result4">
                ...
                <ul class="list">
                    <li>Both enjoy expressing affection through words of affirmation.</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                    <li>Both value spending quality time together.</li>
                    <li>They can create shared experiences and memories.</li>
                ...
                <ul class="list">
                    <li>They may have different expectations regarding acts of service.</li>
                    <li>Quality time preferences may vary.</li>
                    <li>Words of affirmation may not be as important to both.</li>
                    <li>Physical touch preferences may vary.</li>
                </ul>
                <div class="b head">
                Find common ground and compromise to bridge the gap between your love languages. 
                </div>
            ...
            <div class="test_result5">
                ...
                <ul class="list">
                    <li>Both enjoy expressing affection through words of affirmation.</li>
                    <li>They can encourage each other with verbal encouragement.</li>
                    <li>Both enjoy physical affection and closeness.</li>
                    <li>They can strengthen their bond through physical touch.</li>
                ...
                <ul class="list">
                    <li>They may have different expectations regarding acts of service.</li>
                    <li>Quality time preferences may vary.</li>
                    <li>Acts of service preferences may not align.</li>
                    <li>Receiving gifts may not be as significant to both.</li>
                </ul>
                <div class="b head">
                Find common ground and compromise to bridge the gap between your love languages. 
                </div>
